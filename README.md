...
|-----------|-------------|
| **Denominación** | Servicios en Red e Internet |
| **Código** | 0375 |
...
De acuerdo con las **orientaciones pedagógicas oficiales** del currículo andaluz, este módulo profesional contiene la formación necesaria para desempeñar la función de **administración e implantación de servicios de red e Internet**, contribuyendo a alcanzar las competencias propias del título en lo relativo a:

- La instalación, configuración y administración de servicios de red.  
- La gestión y aseguramiento de la información.  
- La aplicación de medidas de seguridad, monitorización y mantenimiento preventivo.  
- La integración de servicios en entornos heterogéneos y su documentación técnica.  
- El fomento de la autonomía, el trabajo colaborativo y la adaptación a la innovación tecnológica.
...
## Contribución del módulo a la adquisición de las competencias del título

El módulo profesional **Servicios de red e Internet (SRI)** contribuye de manera directa a la adquisición de las competencias profesionales, personales y sociales del título de **Técnico Superior en Administración de Sistemas Informáticos en Red**, especialmente en lo relativo a la **instalación, configuración, administración y aseguramiento de servicios de red e Internet**.
...
## Contribución del módulo a la consecución de los objetivos generales del ciclo

El módulo profesional **Servicios de Red e Internet (SRI)** contribuye de forma esencial al logro de los objetivos generales del ciclo formativo de **Administración de Sistemas Informáticos en Red (ASIR)**, proporcionando al alumnado la formación necesaria para la instalación, configuración, administración y aseguramiento de servicios de red e Internet en entornos profesionales reales.
...
g) Se han instalado y configurado herramientas gráficas para realizar videoconferencias.  
...
- **Instalación y configuración de servicios de resolución de nombres:**
  - Tipos de resolución de nombres.
  - Estructura de los servicios jerárquicos de resolución de nombres.
  - Configuración de zonas y dominios.
  - Registros de recursos.
  - Configuración de servidores de nombres primarios y secundarios.
  - Transferencia de zonas.
  - Configuración de servidores de nombres en direcciones IP dinámicas.
  - Seguridad en los servicios de resolución de nombres.
  - Documentación de la instalación y configuración.

- **Instalación y configuración de servicios de configuración automática:**
  - Mecanismos de asignación dinámica de parámetros.
  - Instalación y configuración de servidores de configuración automática.
  - Asignaciones estáticas y dinámicas.
  - Opciones adicionales de configuración.
  - Integración de servicios de configuración automática.
  - Seguridad en los servicios de configuración automática.
  - Documentación de la instalación y configuración.

- **Instalación y configuración de servicios web:**
  - Fundamentos y protocolos asociados.
...
- **Instalación y configuración de servicios de transferencia de archivos:**
  - Protocolos asociados.
  - Instalación y configuración de servidores de transferencia de archivos.
  - Creación de usuarios y grupos.
  - Acceso anónimo y control de acceso.
  - Modos activo y pasivo.
  - Pruebas de acceso mediante diferentes clientes.
  - Documentación de la instalación y configuración.
...
- **Instalación y configuración de servicios de correo electrónico:**
  ...
  - Métodos de seguridad y prevención de usos indebidos.
  - Recogida remota del correo.
  - Configuración de clientes de correo.
  - Firma digital y correo cifrado.
  - Configuración de servidores de correo seguros.
  - Documentación de la instalación y configuración.

- **Instalación y configuración de servicios de mensajería instantánea, noticias y listas de distribución:**
  - Protocolos y características.
  - Instalación y configuración de servicios de mensajería instantánea.
  - Instalación y configuración de servicios de noticias.
  - Instalación y configuración de servicios de listas de distribución.
  - Creación y gestión de cuentas de usuario.
  - Control de acceso a los servicios.
  - Documentación de la instalación y configuración.

- **Instalación y configuración de servicios de audio en red:**
  - Características del servicio de audio.
  - Instalación y configuración de servidores y clientes de audio.
  - Formatos de audio digital.
  - Reproducción y transmisión de audio.
  - Sindicación y suscripción de audio.
  - Documentación de la instalación y configuración.

- **Instalación y configuración de servicios de vídeo en red:**
  - Características del servicio de vídeo.
  - Instalación y configuración de servidores y clientes de vídeo.
  - Formatos de compresión de vídeo digital.
  - Sindicación y suscripción de vídeo.
  - Servicios de videoconferencia.
  - Instalación y configuración de herramientas gráficas y navegadores para videoconferencia.
  - Documentación de la instalación y configuración.

- **Seguridad en servicios de red e Internet:**
  - Técnicas de seguridad y protección.
  - Identificación de riesgos.
  - Aplicación de medidas preventivas.
  - Copias de seguridad.
  - Monitorización y control de servicios.
...
> - 1.º trimestre: **14 semanas** → **70 h** (sin dual).  
> - 2.º trimestre: **11 semanas** → **55 h**, de las cuales **15 h** en **formación dual**.  
> - 3.º trimestre: **7 semanas** → **35 h**, **todas dual**.  
> - **Total módulo:** **160 h** (de ellas, **50 h dual**). 
-->

El desarrollo del módulo profesional **Servicios de Red e Internet (SRI)** durante el curso **2025/2026** se adapta a las particularidades del calendario académico y a las necesidades derivadas de la implantación del modelo **dual**. La planificación anual contempla un total de **175 horas lectivas** a razón de **5 horas semanales**. El calendario lectivo para el curso 2025/2026 restringe la carga horaria a **160 horas lectivas**, de las cuales **50 horas** se desarrollarán en régimen de **formación dual en empresa**. Esta distribución supone un ajuste proporcional respecto a la carga horaria ordinaria del módulo (175 h), manteniendo la coherencia pedagógica y la progresión de los resultados de aprendizaje.  
...
- **UD2:** Servicios de configuración automática de red (RA2)  

**Bloque 2. Servicios de acceso y publicación**  
- **UD3:** Servicios de transferencia de archivos (RA4)  
...
- **Segundo trimestre (11 semanas, 55 h):** Final del Bloque 2, Bloque 3, Bloque 4 y parte del Bloque 5, con **15 horas duales**.  
- **Tercer trimestre (7 semanas, 35 h):** Final del Bloque 5, en su totalidad en **modalidad dual**.

La secuencia garantiza que las competencias técnicas y profesionales se desarrollen progresivamente: primero mediante la administración de servicios de red básicos, posteriormente con servicios de comunicación y publicación, y finalmente con la implementación de servicios multimedia y de seguridad avanzada en entornos duales.
...
|---|---|---:|---:|---|
| 1 | U1: Servicios de resolución de nombres | RA1 | **30** | Presencial |
| 1 | U2: Servicios de configuración automática de red | RA2 | **20** | Presencial |
| 2 | U3: Servicios de transferencia de archivos | RA4 | **10** | Presencial |
| 2 | U4: Servicios web | RA3 | **10** | Presencial |
...
|--------|------------------|----|-------|------------|
| 1 | U1: Servicios de resolución de nombres | RA1 | 30 | 1.º trimestre |
...
|-----------|------------------|-------|
| 1.º | Bloque 1 – Bloque 2 (parcial) | 70 |
...
La configuración dinámica de red es un proceso cotidiano en cualquier infraestructura TI, y su dominio resulta esencial para el **despliegue automatizado de dispositivos y entornos cloud**. El uso de **DHCP y autoconfiguración IPv6** se combina hoy con herramientas de **gestión de red centralizada (NetBox, Infoblox, pfSense)** y **provisión mediante contenedores o IaC**.   La **dedicación de 20 h (12,5 %)** permite abordar tanto las configuraciones básicas como su integración en redes híbridas y virtualizadas, manteniendo su relevancia en el ciclo de vida de la red.

El auge de la **virtualización, contenedores y microservicios** ha consolidado al servidor web como **núcleo funcional** de la mayoría de aplicaciones corporativas. La administración de **Nginx, Apache o servidores embebidos** sigue siendo esencial para el despliegue y mantenimiento de portales, APIs o entornos internos.   La **dedicación de 25 h (15,6 %)** responde a la necesidad de capacitar al alumnado en la configuración segura (HTTPS, certificados, autenticación) y en la comprensión de su integración en arquitecturas modernas (reverse proxy, balanceadores, CDN).

Aunque los servicios clásicos de transferencia como **FTP** han perdido protagonismo frente a soluciones modernas (SFTP, WebDAV, sincronización cloud), siguen siendo relevantes en **entornos de integración continua, backups y migraciones internas**.   El módulo dedica **10 h (6,3 %)** para abordar los principios, protocolos y alternativas seguras, permitiendo al alumnado comprender su rol histórico y actual como base de la transmisión de datos entre sistemas heterogéneos.

El correo electrónico continúa siendo un **servicio crítico a nivel empresarial**, pero su administración ha migrado mayoritariamente hacia **soluciones gestionadas o cloud (Microsoft 365, Google Workspace, Zimbra Cloud)**. Las empresas requieren profesionales capaces de **integrar, asegurar y monitorizar** estos servicios, más que desplegarlos desde cero.   Por ello, el módulo dedica **55 h (34,4 %)** —la carga más alta—, estructuradas entre gestión local y seguridad avanzada en modalidad dual, centrando el aprendizaje en **seguridad, filtrado, enrutamiento y compatibilidad** con servicios cloud híbridos, reflejando la demanda de técnicos especializados en soporte y migración de correo corporativo.

Los servicios de mensajería tradicionales han sido **reemplazados en gran medida por soluciones SaaS y plataformas colaborativas** (Teams, Slack, Mattermost, Rocket.Chat). Sin embargo, la comprensión de sus fundamentos resulta útil para entender **arquitecturas federadas y protocolos de mensajería (XMPP, MQTT)**. La **dedicación de 5 h (3,1 %)** permite introducir estos conceptos en el contexto de la comunicación moderna y su integración con sistemas de colaboración en la nube.

El auge del **teletrabajo, la educación en línea y el consumo de contenidos en streaming** ha impulsado la integración de servicios multimedia en todos los entornos productivos. Plataformas como **YouTube Live, Twitch, Zoom, Meet o Jitsi** emplean tecnologías y protocolos (RTSP, RTP, WebRTC, VoIP) que tienen su origen en los servicios de **audio y vídeo en red**.  
...
- Integra una **fase dual (50 h)** centrada en el despliegue, mantenimiento y securización de servicios en contextos empresariales reales.  

Esta planificación garantiza una formación alineada con los entornos tecnológicos actuales y con las **competencias profesionales demandadas por la industria**, combinando conocimiento técnico, enfoque práctico y adaptación a la evolución del sector.
...
Los instrumentos de evaluación podrán incluir:  
- Observación directa del desempeño en actividades prácticas.  
- Pruebas teórico-prácticas.  
- Pruebas teórico-prácticas en papel.  
- Defensas orales y/o exposiciones.  
- Ejercicios individuales y de grupo.  
- Informes técnicos, memorias y documentación de prácticas.  
